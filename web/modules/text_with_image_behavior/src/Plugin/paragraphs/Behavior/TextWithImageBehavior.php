...
namespace Drupal\text_with_image_behavior\Plugin\paragraphs\Behavior;
 ...
 *   label = @Translation("Paragraph Text with Image settings"),
 *   description = @Translation("Allows to select image size and position."),
 *   weight = 0,
 * )
 */
class TextWithImageBehavior extends ParagraphsBehaviorBase {
  ...
  public function view(array &$build, Paragraph $paragraph, EntityViewDisplayInterface $display, $view_mode) {
    ...
    if ($build['field_article_image']['#formatter'] == 'image') {
      switch ($image_size) {
        case '6_12':
          $build['field_article_image'][0]['#image_style'] = 'image_and_text_6_of_12';
          break;

        case '8_12':
          $build['field_article_image'][0]['#image_style'] = 'image_and_text_8_of_12';
          break;
      }
    }
  }
